...
public class CarServiceImplSortTest {
    ...
    private static Stream<Arguments> comparatorsWithSortedCars() {
        return Stream.of(
                Arguments.of(byMakeComparator, List.of(CAR_BMW_1, CAR_MAZDA, CAR_TOYOTA_1)),
                Arguments.of(byMakeComparatorDesc, List.of(CAR_TOYOTA_1, CAR_MAZDA, CAR_BMW_1)),
                Arguments.of(byPriceComparator, List.of(CAR_MAZDA, CAR_TOYOTA_1, CAR_BMW_1)),
                Arguments.of(byPriceComparatorDesc, List.of(CAR_BMW_1, CAR_TOYOTA_1, CAR_MAZDA)),
                Arguments.of(bySpeedComparator, List.of(CAR_MAZDA, CAR_TOYOTA_1, CAR_BMW_1)),
                Arguments.of(getBySpeedComparatorComparatorDesc, List.of(CAR_BMW_1, CAR_TOYOTA_1, CAR_MAZDA))
        );
    }
